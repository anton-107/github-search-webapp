...
describe('SearchResultsComponent', () => {
  ...
  test('should show error and call retry method', () => {
    ...
    render(<SearchResultsComponent onRetry={mockRetry} repositories={[]} isLoading={false} isAtLeastOneSearchDone={true} searchError={'Error fetching repositories'} />);
  ...
  test('should zero results message', () => {
    render(<SearchResultsComponent onRetry={emptyFn} repositories={[]} isLoading={false} isAtLeastOneSearchDone={true} searchError={null} />);
